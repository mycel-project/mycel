...
class TestNodeRepository:
    class TestDueCountByTypeAndDay:
        ...
        def test_utc_basic_bucketing(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, due_a, node_type)
            _insert_node(node_repo, default_collection, due_b, node_type)
        ...
        def test_tz_offset_shifts_bucket(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, due_ms, NodeType.SPORE)
        ...
        def test_groups_by_type(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, _due_ms(day), NodeType.SPORE)
            time.sleep(0.002)
            _insert_node(node_repo, default_collection, _due_ms(day), NodeType.SPORE)
            time.sleep(0.002)
            _insert_node(node_repo, default_collection, _due_ms(day), NodeType.FRAGMENT)
        ...
        def test_start_end_filter(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, _due_ms("2026-05-01 12:00:00"), NodeType.SPORE)
            _insert_node(node_repo, default_collection, _due_ms("2026-05-15 12:00:00"), NodeType.SPORE)
            _insert_node(node_repo, default_collection, _due_ms("2026-05-31 12:00:00"), NodeType.SPORE)
        ...
        def test_nodes_split_across_days_by_timezone(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, due_a, NodeType.SPORE)
            _insert_node(node_repo, default_collection, due_b, NodeType.SPORE)
        ...
        def test_empty_default_collectionlection(self, node_repo, default_collection):
        ...
        def test_midnight_boundary(self, node_repo, default_collection):
            ...
            _insert_node(node_repo, default_collection, before, NodeType.SPORE)
            _insert_node(node_repo, default_collection, after,  NodeType.SPORE)
